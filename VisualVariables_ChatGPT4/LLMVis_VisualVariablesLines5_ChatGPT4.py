...
# Create a line chart with green lines and the data points encoded with purple squares
for column in df_pivot.columns:
    plt.plot(df_pivot.index, df_pivot[column], color='green', marker='s', markerfacecolor='purple')
