...
# Create an XY heatmap using seaborn without cell labels
plt.figure(figsize=(10, 8))
sns.heatmap(heatmap_data, cmap='viridis', annot=False, fmt=".2f", linewidths=.5, cbar_kws={'label': 'Quantitative C'})
